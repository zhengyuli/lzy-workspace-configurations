...

;;;### (autoloads nil "tty-format" "tty-format.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tty-format" '(#("tty-format-add-faces" 0 20 (fontified nil)))))
